...
$.ajax({url: "http://staging.eimpressive.com/slim-cor/dash_sh_new.php?region="+region+"&regionsection="+regionsection+"&state="+state,
    ...
    success: function (result) {
      ...
      if(result[0]){
        ...
        sessionStorage.setItem("sh_new_veri_list",JSON.stringify(result[0]));
        //sessionStorage.setItem("sh_new_veri_list_count",JSON.stringify(result[1]));
        sessionStorage.setItem("insertassign_employment_array",JSON.stringify(result[1]));
        sessionStorage.setItem("insertassign_education_array",JSON.stringify(result[2]));
    ...
    success: function (result) {
      ...
      if(result[0]){
        ...
        sessionStorage.setItem("Inprogress_sh",JSON.stringify(result[0]));
         sessionStorage.setItem("assests_verification_array",JSON.stringify(result[1]));
        sessionStorage.setItem("bankguarantee_verification_array",JSON.stringify(result[2]));
        sessionStorage.setItem("address_verification_array",JSON.stringify(result[3]));
...
$.ajax({url: "http://staging.eimpressive.com/slim-cor/dash_reject_sh.php?region="+region+"&regionsection="+regionsection+"&state="+state,
    ...
    success: function (result) {
      ...
      if(result[0]){
        $("#popupsearchmade").popup("open");
        sessionStorage.setItem("sh_reject_list",JSON.stringify(result[0]));
        sessionStorage.setItem("insertassign_employment_array",JSON.stringify(result[1]));
        sessionStorage.setItem("insertassign_education_array",JSON.stringify(result[2]));
        sessionStorage.setItem("insertassign_address_array",JSON.stringify(result[3]));
        sessionStorage.setItem("assests_verification_array",JSON.stringify(result[4]));

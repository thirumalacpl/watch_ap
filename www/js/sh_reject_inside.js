...
address_verii =  JSON.parse(sessionStorage.getItem("address_verii"));
...
$('#secondda').append( '<option value="New">Select Status</option><option value="'+super_obj.Username+'">'+super_obj.Username+'</option>');
}
